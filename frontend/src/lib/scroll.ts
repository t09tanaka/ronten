...
/// request-changes verdict is chosen, mirroring the `i` shortcut, so the
/// next action (writing the reason) needs no extra navigation. Instant
/// scroll on purpose: animated scrolling stalls in throttled or embedded
/// browser contexts, and an instant jump also satisfies
